// Functional Programing ==> Paradigm use pure functionsh
...
class Program
{
    ...
    static void Method(Delegate deleg)
    {
        deleg.Invoke();

        Console.WriteLine("Delegate Has Invoked");
    }
}

// Generic Delegate ---> Action - Func<in , out> - Predicate<in>
 */
#endregion
...
//static void RunExtensionFunctional01()
//{
...
//static void RunExtensionFunctional02()
//{
//    var list = Repository.LoadEmployees();
...
var emps = employees.Partitaining(page, size);

var start = page * size + 1;
var end = emps.Count() + start-1;

emps.Print($" employees from {start} to {end}");